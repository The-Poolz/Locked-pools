...
contract('Access to Locked Deal', accounts => {
    let instance, Token, fromAddress = accounts[0], poolId, FeeToken
    let owner = accounts[9], allow = 100
    ...
    before(async () => {
        ...
        // await instance.CreateNewPoolERC20(Token.address, startTime, finishTime, allow, owner, FeeToken.address, { from: fromAddress })
        await instance.CreateNewPoolMain(Token.address, startTime, finishTime, allow, owner, { from: fromAddress })
        ...
        let tx = await instance.CreateNewPoolERC20(Token.address, startTime, finishTime, allow, owner, FeeToken.address, { from: fromAddress })
    ...
    describe('Fail Tests', () => {
        ...
        it('Fail to Create Pool with 0 address owner', async () => {
            ...
            await truffleAssert.reverts(instance.CreateNewPoolMain(Token.address, startTime, finishTime, allow, zero_address, { from: fromAddress }), "Zero Address is not allowed")
            await truffleAssert.reverts(instance.CreateNewPoolERC20(Token.address, startTime, finishTime, allow, zero_address, FeeToken.address, { from: fromAddress }), "Zero Address is not allowed")
        })
